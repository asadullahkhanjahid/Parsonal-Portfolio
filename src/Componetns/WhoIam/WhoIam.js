...
import riyajul from "../../Images/IMG_4137111.png";
const WhoIam = () => {
  return (
    <div className="my-5" id="about">
      <div className="row container-fluid">
        ...
        <div className="col-lg-5 col-sm-12  d-flex align-items-center">
          <div className="">
            <h1 className="text-info">Md:Asadullah Khan Jahid</h1>
            <div className="d-flex">
              ...
              />
              <h4>
                A 20 Years old Bangladeshi, Full Stack Web Developer and Self
                taught web designer.
              </h4>
            </div>
            <h5>
